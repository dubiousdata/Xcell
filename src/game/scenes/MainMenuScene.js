...
/*
    create() {
        ...
        // Start Game button
        const startButton = this.add.text(200, 200, 'Start Game', { fontSize: '24px', fill: '#0f0' }).setOrigin(0.5);
        ...
        // Settings button
        const settingsButton = this.add.text(400, 250, 'Settings', { fontSize: '24px', fill: '#0f0' }).setOrigin(0.5);
